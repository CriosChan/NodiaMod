...
public class GuiCustomMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, i + 72 + 12 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, i + 72 + 12 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(30, this.width / 2 - 100, i + 24 * 2, 99, 20, EnumChatFormatting.BLUE + "Discord"));
        this.buttonList.add(new GuiButton(31, this.width / 2 + 2, i + 24 * 2, 99, 20, EnumChatFormatting.GREEN + I18n.format("menu.website", new Object[0])));
        this.buttonList.add(new GuiButton(32, this.width / 2 - 100, i + 24 * 1, EnumChatFormatting.DARK_GREEN + I18n.format("menu.connect", new Object[0])));
        this.buttonList.add(new GuiButton(33, this.width / 2 - 100, i + 24 * 3, 99, 20, EnumChatFormatting.RED + "Changelog"));
        this.buttonList.add(new GuiButton(34, this.width / 2 + 2, i + 24 * 3, 99, 20, EnumChatFormatting.BLACK + "Forum"));
        this.buttonList.add(new GuiButton(34, this.width - 99, 0, 99, 20,  I18n.format("menu.change", new Object[0])));
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        tessellatorTitle.addVertexWithUV(this.width / 2 - 100, 20, this.zLevel, 0, 0);
        tessellatorTitle.addVertexWithUV(this.width / 2 - 100, 80, this.zLevel, 0, 1);
        tessellatorTitle.addVertexWithUV(this.width / 2 +100, 80, this.zLevel, 1, 1);
        tessellatorTitle.addVertexWithUV(this.width / 2 + 100, 20, this.zLevel, 1, 0);
